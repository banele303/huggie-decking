...
const FloatingContactButtons = () => {
    return (
        <div className="fixed bottom-10 right-5 z-50 flex flex-col gap-3">
            {/* Call Button */}
            <motion.a
                href="tel:+27692389358"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
                className="flex items-center justify-center w-12 h-12 rounded-full bg-amber-600 text-white shadow-lg hover:bg-amber-700 transition-colors"
                aria-label="Call us"
            >
